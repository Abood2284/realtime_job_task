...
@immutable
class PrevEmployeeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // final currEmp Provider.of<Employee>(context);
    return Expanded(
      flex: 1,
      child: Column(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Dismissible(
                  ...
                  child: InkWell(
                    onTap: () {
                      // * Navigate to Edit Employee Deatils Screen
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              currEmp[index].endDate != null
                                  ? "${DateFormat('d MMM y').format(DateTime.parse(currEmp[index].startDate!.toString()))} ➡️ ${DateFormat('d MMM y').format(DateTime.parse(currEmp[index].endDate!.toString()))}"
